...
public class HtmlConverter {
    ...
    private static final String LOG_TAG = "HtmlConverter";
    ...
    */
    ...
    private static String simpleTextToHtml(String text) {
        ...
        try {
            ...
            //Should never happen
            Log.e(LOG_TAG, "Could not read string to convert text to HTML:", e);
        }
     ...
     *  </p>
     *
     * @return A {@code <style>} element that can be dynamically included in the HTML
     * {@code <head>} element when messages are displayed.
     */
    public static String cssStylePre() {
        // TODO: 要加字体选择功能
//        final String font = Account.getSingleton().messageViewFixedWidthFont()
//                ? "monospace"
//                : "sans-serif";
    ...
    /**
     * Convert HTML to a {@link android.text.Spanned} that can be used in a {@link android.widget.TextView}.
     *
     * @param html The HTML fragment to be converted.
     * @return A {@link android.text.Spanned} containing the text in {@code html} formatted using spans.
     */
    ...
    /**
     * {@link android.text.Html.TagHandler} that supports unordered lists.
     *
